        ...
        public TransactionDetailsForm(string acc)
        {
            ...
            while (reader.Read())
            {
                ...
                if (accfrom==Convert.ToInt32(tdaccno))
                {
                    ...
                    pb[i].Image = Image.FromFile(@"C:\Users\ayann\OneDrive\Desktop\vs\speed_cash\images\red arrow.png");
                ...
                else
                {
                    ...
                    pb[i].Image = Image.FromFile(@"C:\Users\ayann\OneDrive\Desktop\vs\speed_cash\images\green left.jpg");
