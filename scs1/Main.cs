...
namespace scs1
{
    public partial class Main : Form
    {
        ...
        public Main(string user, string acc, string a)
        {
            ...
            pictureBox1.Image = Image.FromFile(@"C:\Users\ayann\OneDrive\Desktop\vs\speed_cash\images\imageedit_5_6548876356.png");

            OleDbConnection connection = new OleDbConnection();
            connection.ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\ayann\OneDrive\Desktop\vs\speed_cash\database new\databasenew.accdb";
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                pictureBox1.Image = Image.FromFile(@"C:\Users\ayann\OneDrive\Desktop\vs\speed_cash\images\imageedit_7_5994521692.png");
            }
        }
